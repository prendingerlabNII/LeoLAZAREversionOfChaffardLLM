...
class Llamatest(nn.Module):
    def __init__(self, configs, device):
        ...
        self.llama2 = model = MambaLMHeadModel.from_pretrained("state-spaces/mamba-2.8b-slimpj")
        ...
        self.token = AutoTokenizer.from_pretrained("EleutherAI/gpt-neox-20b")
        ...
        self.device = device
        self.in_layer_voc = nn.Linear(in_features= 50280,out_features= self.voc)
        ...
        self.embed = self.llama2.backbone.embedding
        self.voc_in = self.embed(torch.tensor(range(50280)))
    ...
    def forward(self, x, itr):
        ...
        dec_out = self.output_projection(dec_out[:,-12:,:])
